        ...
        <ul class="grid grid-cols-4 gap-5">
          <li class="my-5 overflow-hidden" v-for="product in sortedProducts" :key="product.id">
            <div class="overflow-hidden w-[350px] relative">
                <img class="w-[330px] h-[330px] hover:scale-110 transition-transform duration-300"  :src="product.image">
                ...
                <div class="absolute right-24 top-16 w-10 h-10 rounded-full bg-gray-200 flex justify-center items-center hover:text-gray-600 hover:shadow-lg cursor-pointer bg-opacity-50">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-400 hover:text-gray-600">
            ...
            <div class="px-4">
                ...
                <div class="my-2 text-lg font-bold">{{ product.name }}</div>
...
export default {
  data() {
    ...
    this.$store.dispatch("setFilteredProducts", "Table");
  },
  computed: {
    filteredProducts() {
